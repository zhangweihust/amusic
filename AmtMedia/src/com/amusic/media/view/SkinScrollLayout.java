 ...
 * 
 */
public class SkinScrollLayout extends ViewGroup {
	...
	public SkinScrollLayout(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
		// TODO Auto-generated constructor stub
	}

	public SkinScrollLayout(Context context, AttributeSet attrs, int defStyle) {
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_UP:
			...
			MediaApplication.logD(SkinScrollLayout.class, "velocityX:" + velocityX);
			if (velocityX > SNAP_VELOCITY && mCurScreen > 0) {
				// Fling enough to move left
				//Log.e(TAG, "snap left");
				onScreenChangeListener.onScreenChange(mCurScreen - 1);
				MediaApplication.logD(SkinScrollLayout.class, " snap left mCurScreen=" + (mCurScreen - 1));
				...
				//只往右移动才加载数据
				onScreenChangeListenerDataLoad.onScreenChange(mCurScreen+1);
				MediaApplication.logD(SkinScrollLayout.class, " snap right mCurScreen=" + (mCurScreen - 1));
				snapToScreen(mCurScreen + 1);
			} else {
				snapToDestination();
			}
