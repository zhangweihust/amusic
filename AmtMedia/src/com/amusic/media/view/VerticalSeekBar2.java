...
//    private int height;
//    private int width;
    public interface OnVertivalSeekBarChangeListener {
        void onProgressChanged(VerticalSeekBar2 VerticalSeekBar, int progress, boolean fromUser);
        void onStartTrackingTouch(VerticalSeekBar2 VerticalSeekBar);
        void onStopTrackingTouch(VerticalSeekBar2 VerticalSeekBar);
    }

    private OnVertivalSeekBarChangeListener mOnSeekBarChangeListener;
    ...
    public void setOnVertivalSeekBarChangeListener(OnVertivalSeekBarChangeListener l) {
   ...
   protected void onDraw(Canvas c)
        {        // 鏃嬭浆
                c.rotate(-90);
              //鎺у埗宸﹀彸浣嶇疆锛岃鑷繁璋冭瘯锛屽鏋淪eekBar鏈夊亸宸彲浠ュ湪杩欓噷璋冩暣
...
//                this.setMeasuredDimension(width, height);
   ...
   public void setThumb(Drawable thumb)
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        //Added by jiaming.wang@archermind for lyricmaker verticalSeekBar
        return false;
