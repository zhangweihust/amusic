...
public class SwingMusicSeekBarPreference extends DialogPreference implements
OnSeekBarChangeListener {
	...
	public SwingMusicSeekBarPreference(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	protected void onDialogClosed(boolean positiveResult) {
		...
		if(positiveResult){
			...
			progress  = PreferencesUtil.getsensitivityLashingProgressSP();
		}
	}
