...
public class VerticalSeekBar1 extends AbsSeekBar {
    private Drawable mThumb;
//    private int height;
//    private int width;
    public interface OnVertivalSeekBarChangeListener {
        void onProgressChanged(VerticalSeekBar1 VerticalSeekBar, int progress, boolean fromUser);
        void onStartTrackingTouch(VerticalSeekBar1 VerticalSeekBar);
        void onStopTrackingTouch(VerticalSeekBar1 VerticalSeekBar);
    }
