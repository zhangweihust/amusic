...
public class VerticalSeekBar extends AbsSeekBar {
    ...
    private int height;
    private int width;
    public interface OnSoundSeekBarChangeListener {
        void onProgressChanged(VerticalSeekBar VerticalSeekBar, int progress, boolean fromUser);
        void onStartTrackingTouch(VerticalSeekBar VerticalSeekBar);
        void onStopTrackingTouch(VerticalSeekBar VerticalSeekBar);
    }

    private OnSoundSeekBarChangeListener mOnSeekBarChangeListener;
	...
	public void setOnSeekBarChangeListener(OnSoundSeekBarChangeListener l) {
